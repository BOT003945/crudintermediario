...
class Pacientesns extends Component
{
    ...
    public function store()
    {
		...
		session()->flash('message', 'Pacientesn Successfully created.');
    }

    public function edit($id)
    {
        $record = Pacientesn::findOrFail($id);

        $this->selected_id = $id; 
		$this->idPaciente = $record-> idPaciente;
    ...
    public function update()
    {
        ...
        if ($this->selected_id) {
			$record = Pacientesn::find($this->selected_id);
            $record->update([ 
			'idPaciente' => $this-> idPaciente,
			'sucursal' => $this-> sucursal,
			'Paciente' => $this-> Paciente,
            ...
            $this->resetInput();
            $this->updateMode = false;
			session()->flash('message', 'Pacientesn Successfully updated.');
        }
    }
