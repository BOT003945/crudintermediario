...
@section('content')
{!!Form::open(array('url'=>'/formatos','method'=>'POST','autocomplete'=>'off'))!!}
{{Form::token()}}
            ...
            <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                <div id="detalle-orden" class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <input class="form-control" id="descripcion" name="descripcion" maxlength="100" required>
                        </div>                            
                    </div>
                    <hr>
                    <div class="row">
...
@if($message = Session::get("error"))
	<div style="text-align:left" class="alert alert-danger">
		<p>{{$message="Error. El ID del departamento no existe, eliga y guarde un departamento en la prueba seleccionada para poder guardar."}}</p>
