...
<div class="card">
    <div class="card-header">
        <a href="formatos/create" style="text-decoration:none;color:aliceblue;" class="float-right d-none d-sm-block">
                ...
                <tbody>
                    @foreach ($estudios as $estudio)
                        <tr>
                            ...
                            <td>
                                <form class="formulario" action="{{route('formatos.destroy',$estudio->id)}}" method ="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{route('formatos.edit',Crypt::encrypt( $estudio->id ))}}" class="btn-xs btn-primary fa fa fa-pencil"><i class="fa fa-edit"></i></a>
