...
@section('content_header')
    <h2>Configuración del Formato</h2>
@stop

@section('content')
<form enctype="multipart/form-data" action="/formatos/{{$estudio->id}}" method="POST">
    @csrf
    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <select id="horas" class="selectpicker show-tick" data-dropup-auto="false" data-width="fit" name="horas">
                                <option value="{{$estudio->horas}}" selected>{{$estudio->Horas}}</option>
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="form-check">
                                <input value="{{$estudio->ventaindividual}}" {{$estudio->ventaindividual=="1"?'Checked':''}} data-val="true" id="ventaindividual" name="ventaindividual" type="checkbox" value="1"><input hidden name="ventaindividual" type="text" value="1">
...
<div class="card">
    <div style="text-align:left" class="card-header">
        ...
        <a href="/formatos" type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
...
<div class="card" id="tabla_normalidad">
    ...
    <div class="card-body">
        <p style="color: brown">* Para modificar el orden de las pruebas arrastre las pruebas hacia arriba y abajo</p>
        ...
        <div class="container-fluid">
            {{-- <div class="table-responsive"> --}}
                <div class="row" id="tabla_formatos">
                    ...
                    <div id="fila{{$formato->id}}" class="col-md-12">
                        <div class="card card-light" style="background-color:rgba(128, 128, 128, 0.226);">
                            <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                                <div class="container">
                                    <div class="row">
                                        <input type="hidden" name="prueba[]" value="{{$formato->idprueba}}">
                                        ...
                                        <div class="col-7">
                                            <input name="pruebaTexto" readonly value="{{$formato->idprueba}}-{{$formato->Prueba}}" class="form-control" style="border-color: rgba(255, 255, 255, 0);background-color:rgba(0, 0, 0, 0);">
                                        </div>
                                        <div class="col-2">
                                            <button style="border:0;background-color: #dc354600;" type="button" class="botonEliminarB float-right" onclick="deshacer('{{$formato->id}}');">
