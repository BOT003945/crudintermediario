...
<div style="background-color:rgba(240, 248, 255, 0);">
    <div style="text-align:right" >
        <a href="/paquetes"><button type="button" class="btn btn-secondary"><i class="far fa fa-arrow-left">
        </i> Regresar</button></a>    
    </div>   
</div>
@stop
                ...
                <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                    <div id="detalle-orden" class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <textarea class="form-control" id="indicaciones" name="indicaciones" maxlength="150">
                                    {{$paquete->Indicaciones}}
                                </textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-7">
                                <textarea class="form-control" id="notas_internas" name="notas_internas" maxlength="150">
                                    {{$paquete->Notas_Internas}}
                                </textarea>
                            </div>
                        </div>
                        <hr>
    ...
    <div class="card-body">
        ...
        <div class="container-fluid">
                <div class="row" id="tabla_paquetes">
                    ...
                    <div id="fila{{$paquetedetalle->idPaqueteDetalle}}" class="col-md-12">
                        <div class="card card-light" style="background-color:rgba(128, 128, 128, 0.226);">
                            <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                                <div class="container">
                                    <div class="row">
                                        <input type="hidden" name="prueba[]" value="{{$paquetedetalle->id_Estudio}}">
                                        <input type="hidden" name="estudioNombre[]" value="{{$paquetedetalle->Estudio}}">
                                        <div class="col-1">
                                        ...
                                        <div class="col-7">
                                            <input name="pruebaTexto" readonly value="Estudio-{{$paquetedetalle->id_Estudio}}-{{$paquetedetalle->Estudio}}" class="form-control" style="border-color: rgba(255, 255, 255, 0);background-color:rgba(0, 0, 0, 0);">
                                        </div>
                                        <div class="col-2">
