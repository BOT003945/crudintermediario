    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Empresasn</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="idEmpresa" type="text" class="form-control" id="idEmpresa" placeholder="Idempresa">@error('idEmpresa') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="pacientesN_Mes"></label>
                <input wire:model="pacientesN_Mes" type="text" class="form-control" id="pacientesN_Mes" placeholder="Pacientesn Mes">@error('pacientesN_Mes') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="pacientesN_Acum"></label>
                <input wire:model="pacientesN_Acum" type="text" class="form-control" id="pacientesN_Acum" placeholder="Pacientesn Acum">@error('pacientesN_Acum') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
