    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Pacientesn</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="idPaciente" type="text" class="form-control" id="idPaciente" placeholder="Idpaciente">@error('idPaciente') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
