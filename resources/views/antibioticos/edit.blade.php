	...
	<div class="container-fluid card" style="width:40%;" >
		<div class="modal-body">
			<div id="CreaContainer">                                       
				<form  class="frmpacientes" id="createpacientes" enctype="multipart/form-data" action="/antibioticos/{{$antibiotico->id}}" method="POST">
					@csrf
					@method('PUT')
							    ...
							    <div class="card">
									<div class="card-body">
										...
										<div class="form-group">
											...
											<input onkeypress="return soloLetras(event)" required class="form-control text-box single-line" value="{{$antibiotico->descripcion}}" id="descripcion" minlength="2" maxlength="100" name="descripcion" type="text" tabindex="4">
										</div>
