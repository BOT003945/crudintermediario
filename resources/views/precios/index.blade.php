                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <button style="text-align:left" type="button" id="btnModal{{$precio->idPrecio}}" value="{{$precio->idPrecio}}~{{$precio->Abreviatura}}~{{$precio->Descripcion}}" onclick="modal('{{$precio->idPrecio}}')" data-toggle="modal" data-target="#updatePrecioModal" class="btn-xs btn btn-primary fa fa fa-pencil">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <form class="formulario" action="{{route('precios.destroy',$precio->idPrecio)}}" method ="POST">
                                                   ...
                                                   <button style="text-align:center" class="btn-xs btn btn-danger"><i class="fa fa-trash"></i></button>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <form action="{{route('precios_detalle.index')}}">
                                                    ...
                                                    <button class="btnCheck btn-xs btn btn-info fa fa fa-pencil">
