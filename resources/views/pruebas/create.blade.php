                ...
                <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                    <div id="detalle-orden" class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <input id="formula" name="formula" maxlength="30" class="form-control">
                            </div>                            
                        </div>
                        <hr>
                        <div class="row">
...
<div class="card" id="tabla_normalidad" style="display: none">
    <div class="card-header">
        ...
        <button id="btnAgregar" type="button" class="float-right d-none d-sm-block btn btn-info" data-toggle="modal" data-target="#exampleModal">
