                    ...
                    <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                        <div id="detalle-orden" class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <input value="{{$prueba->formula}}" id="formula" name="formula" maxlength="30" class="form-control">
                                </div>                            
                            </div>
                            <hr>
                            <div class="row">
                        ...
                        <div class="card-body" style="margin: 5px !important; padding: 5px !important;">
                            <div id="asignacion-orden" class="container">
                                ...
                                <div class="row" id="textolibre" style="display: none">
                                    ...
                                    <div class="col-7">
                                        <textarea rows="4" cols="10" class="form-control" id="valor_normalidad_texto" name="valor_normalidad_texto" maxlength="200">
                                            {{$prueba->valor_normalidad_texto}}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
...
@if($message = Session::get("error"))
	<div style="text-align:left" class="alert alert-danger">
		<p>{{$message="No haga eso."}}</p>
	</div>
@endif
{{-- @if($message = Session::get("Error_guardado"))
	<div style="text-align:left" class="alert alert-danger">
		<p>{{$message="Error de guardado."}}</p>
	</div>
@endif	 --}}
<center><div class="card" id="tabla_normalidad" style="display: none">
    <div class="card-header">
        <h3 class="float-left">Valores de referencia</h3>
        @if(session('mensaje_valor_agregado')=='mensaje')
		<p class="float-center d-none d-sm-block btn btn-info">Éxito</p>
		@endif
        <button type="button" id="btnAgregar" class="float-right d-none d-sm-block btn btn-info" data-toggle="modal" data-target="#exampleModal">
            <i class="far fa fa-plus-square"></i> Agregar    
        </button>
        <input id="Redireccionador" type="hidden" name="Redireccionador" type="text">
                            ...
                            @foreach ($valoresreferancias as $valoresreferancia)
                                <tr id="fila{{$valoresreferancia->id}}">
                                    ...
                                    <td style="width: 8%;">
                                        ...
                                        {{-- @include('pruebas/valores/valoresUpdate') --}}
                                    </td> 
                                </tr>
                            @endforeach
                            @endif
...
{{-- @if(session('redireccionar')=='tabla')
<script>
location.hash = "#valoresref";
alert('Valores de normalidad registrados.');
</script>
@endif --}}
